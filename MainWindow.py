...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dltsSample = ScientificDoubleSpinBox()
        ...
        self.dltsTWidth.setValue(0.001)
        self.dltsSample.setValue(0.150)
        self.mfiaSample.setMaximum(857144)
        self.mfiaSample.setValue(107143)
        self.mfiaFreq.setMaximum(int(5e6))
        self.mfiaFreq.setValue(int(1e6))
